...
<head>
    ...
    <title>Business Companion | Add Customer</title>
                ...
                <div class="col-md-6">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">Customer Add Form</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                            ...
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    <div class="box-footer">
                                        ...
                                        <button type="submit" onclick="window.location='list_customers.php';return false;" class="btn btn-default">Cancel</button>
...
//        print_r($result);
                                        if (empty($result)) {
                                            ...
                                            $conn = null;
                                            echo "<div class=\"alert alert-success no-print\"><strong>Customer Added Successfully!</strong></div>";

                                            if ($setting_AddCustomer == 'redirect') {
...
<!--                                            <button type="submit" onclick="window.location='../list_customers.php';return false;">Cancel the add, take me back</button>-->
                                    ...
                                    echo "Please fill in the form to add a new customer. The only required field is \"Customer Name\"</br>";
                                }
                                ?>
                            </div>
                            <!-- /.box-body -->
